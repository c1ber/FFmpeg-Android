...
#define FFMPEG_CONFIGURATION "--libdir=android-libs/x86_64 --arch=x86_64 --cpu=x86_64 --cross-prefix=/home/peter/Android/ndk/android-ndk-r14b//toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android- --sysroot=/home/peter/Android/ndk/android-ndk-r14b//platforms/android-21/arch-x86_64/ --extra-cflags='-march=x86-64 -msse4.2 -mpopcnt -m64 -mtune=intel' --extra-ldexeflags=-pie --disable-asm --target-os=android --disable-static --enable-shared --disable-doc --disable-programs --disable-everything --disable-gpl --disable-nonfree --disable-avdevice --disable-avformat --disable-swscale --disable-postproc --disable-avfilter --disable-symver --disable-swresample --enable-avresample --enable-decoder=vorbis --enable-decoder=opus --enable-decoder=flac --enable-decoder=alac --enable-decoder=mp3 --enable-decoder=amrnb --enable-decoder=amrwb --enable-decoder=aac --enable-decoder=ac3 --enable-decoder=eac3 --enable-decoder=dca --enable-decoder=mlp --enable-decoder=truehd"
